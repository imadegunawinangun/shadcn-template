...
export function DashboardLayout({
  ...
  // If sections is not provided, resolve it using appId and isAdmin
  const resolvedSections = (sections || getNavigation(appId, isAdmin)) || [];

  return (
    <SidebarProvider>
      <AppSidebar 
        sections={resolvedSections as any} 
        user={user} 
        brand={brand} 
