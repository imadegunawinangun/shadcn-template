...
import { getUserAiConfigAction, updateUserAiConfigAction } from "../../../actions/user-ai-actions"
...
interface UserAiSettingsFormProps {
  className?: string
...
export function UserAiSettingsForm({ className, showCardHeader = true, onSaveSuccess }: UserAiSettingsFormProps) {
    ...
    <Card className={cn("border border-border/50 bg-card/30 backdrop-blur-md transition-all duration-200 hover:shadow-md", className)}>
      {showCardHeader && (
        <CardHeader className="flex flex-row items-center gap-4 space-y-0">
          ...
          <div>
            <CardTitle className="text-lg">Personal AI Configuration</CardTitle>
            <CardDescription>
              Configure your personal AI assistant using your own API key (BYOK).
            </CardDescription>
          </div>
        </CardHeader>
      )}
